        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin: 0 20px">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item <?php echo $title == 'Plus two numbers' ? 'action' : ''; ?>">
                    <a class="nav-link" href="sum.php">Plus two
                        numbers<?php echo $title == 'Plus two numbers' ? '<span class="sr-only">(current)</span>' : ''; ?></a>
                </li>
                <?php if ($curentUser) : ?>
                <li class="nav-item <?php echo $title == 'Profile' ? 'action' : ''; ?>">
                ...
                <li class="nav-item <?php echo $title == 'Change Password' ? 'action' : ''; ?>">
                    <a class="nav-link" href="change_password.php">Change
                        Password</a><?php echo $title == 'Change Password' ? '<span class="sr-only">(current)</span>' : ''; ?></a>
                </li>
                <?php else : ?>
